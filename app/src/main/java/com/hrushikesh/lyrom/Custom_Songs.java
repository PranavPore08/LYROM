...
public class Custom_Songs extends AppCompatActivity {
    ListView listofsong;
    String[] items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listofsong=findViewById(R.id.list_item);
        display();
    }
    ...
    void display(){
        ...
        listofsong.setAdapter(myadapter);

        listofsong.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                String songName=listofsong.getItemAtPosition(i).toString();
